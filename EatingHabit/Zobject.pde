...
float ZSTEP = 0.008;
color BACKGROUND = color(255, 255, 255,100);
...
void Zobject_setup() {
    ...
    for (int i=0; i<N; i++) {
        objects.add(new ZObject(random(1.0f), random(1.0f), random(1.0f), color(random(255.0, 255.0), random(200.0, 220.0), random(190.0, 220.0),100)));
    }
